...
- [ ] 잘못된 입력을 받으면 에러를 생성, 다시 입력을 받는다.
- [ ] 구매가 더 이상 불가능 할 때까지 구매할 상품 명을 입력 받는다.
...
- [ ] 총 금액이 양수인지 검증
- [ ] 총 금액을 통해 동전을 무작위로 생성
- [ ] 잔돈을 돌려줄 때는 현재 보유한 최소 개수의 동전으로 잔돈을 돌려 준다.

- VendingMachineMenu
- 자판기의 상품명, 가격, 수량 입력에 대한 VO
- [ ] 상품 가격은 100원 이상, 10으로 나누어 떨어져야 한다.
- [ ] 상품명이 중복되는 경우 검증
- [ ] 수량이 양수인지 검증

...
+ [x] 자판기가 보유하고 있는 금액 입력받기
  + 예외처리->"[ERROR] 금액은 숫자여야 합니다."
    + 숫자가 아닌 경우
  + 10으로 나누어떨어지지 않는 경우
+ [x] 자판기가 보유하고 있는 금액으로 동전 무작위로 생성
  + 500,100,50,10
+ [x] 상품명과 가격, 수량을 입력받기
  + 상품명, 가격, 수량은 쉼표로 분리
  + 개별 상품은 대괄호로 묶어 세미콜론으로 분리
  + [x] 상품가격 예외처리->"[ERROR] 상품 등록 양식이 올바르지 않습니다."
    + 100원 미만
    + 10원으로 나누어 떨어지지 않는 수
  + [x] 개별상품 예외처리->"[ERROR] 상품 등록 양식이 올바르지 않습니다."
    + 쉼표, 대괄호, 세미콜론 위치의 오류
+ [x] 상품명, 가격, 수량을 저장하기
+ [x] 사용자에게 투입금액 입력받기
+ + [x] 예외처리->"[ERROR] 금액은 숫자여야 합니다."
  + [x] if 금액이 최저가격보다 적거나 상품이 없는 경우 바로 돈 반환하기
+ [x] 구매할 상품명 입력받기
  + 예외처리->"[ERROR] 해당 상품은 구매할 수 없습니다."
  + [x] 투입금액보다 더 큰 상품을 구매할 때 다시 입력받게 하기
+ [x] 잔돈 반환하기 전까지 구매하기 진행
+ [x] 남은 금액이 상품의 최저가격보다 적거나, 모든 상품이 소진된 경우 잔돈 반환
  + [x] 잔돈을 반환할 수 있는 경우 잔돈 반환
  + [x] 잔돈을 반환할 수 없는 경우 잔돈으로 반환할 수 있는 금액만 반환
    + [x] ex) 400원 반환해야하는데 500원짜리밖에없을 경우 반환하지 않음
    + [x] 자판기 금액보다 반환금이 클 경우 모두 반환
